...
public class StudentLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Welcome to Quiz Software");
        ...
        jLabel11.setText("3. You CANNOT change the type of question, once selected.");

        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("A : >80");

        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("4. Grading System:");
        ...
        jLabel19.setForeground(new java.awt.Color(242, 241, 240));
        ...
        ep.setText("jTextField1");

        en.setText("jTextField2");

        mp.setText("jTextField3");

        mn.setText("jTextField4");

        hp.setText("jTextField5");

        hn.setText("jTextField6");
    ...
    void setArr(ArrayList<Integer> arr){
        try{
            this.arr = arr;
            ep.setText(String.valueOf(arr.get(0)));
            en.setText(String.valueOf(arr.get(1)));
            mp.setText(String.valueOf(arr.get(2)));
            mn.setText(String.valueOf(arr.get(3)));
            hp.setText(String.valueOf(arr.get(4)));
            hn.setText(String.valueOf(arr.get(5)));
            dur.setText(String.valueOf(arr.get(6)));
        }
        catch(Exception e){
    ...
    private void buttonContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonContinueActionPerformed
        ...
        else
        {
            ...
            QuizInterface quiz = new QuizInterface(textName.getText(), textRN.getText());
            quiz.setArr(arr);
